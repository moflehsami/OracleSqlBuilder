...
namespace OracleSqlBuilder {
	...
	public class OracleSqlExecNonQuery {
		...
		//internal OracleSqlNonData Execute(string ConnectionString, params OracleSqlBuilderInsert[] Inserts) {
		...
		///// <param name="Inserts">The instance/s of OracleSqlBuilderInsert.</param>
		///// <returns>The instance of OracleSqlNonData.</returns>
		//internal OracleSqlNonData Execute(params OracleSqlBuilderInsert[] Inserts) {
		...
		///// <returns>The instance of OracleSqlNonData.</returns>
		//internal OracleSqlNonData Execute(string ConnectionString, params OracleSqlBuilderUpdate[] Updates) {
		//	if (String.IsNullOrWhiteSpace(ConnectionString)) {
		//		throw new ArgumentNullException("Connection String argument should not be null.");
		//	}
		//	if (Updates == null) {
		...
		///// <param name="Updates">The instance/s of OracleSqlBuilderUpdate.</param>
		///// <returns>The instance of OracleSqlNonData.</returns>
		//internal OracleSqlNonData Execute(params OracleSqlBuilderUpdate[] Updates) {
		...
		///// <returns>The instance of OracleSqlNonData.</returns>
		//internal OracleSqlNonData Execute(string ConnectionString, params OracleSqlBuilderDelete[] Deletes) {
		//	if (String.IsNullOrWhiteSpace(ConnectionString)) {
		//		throw new ArgumentNullException("Connection String argument should not be null.");
		//	}
		//	if (Deletes == null) {
		...
		///// <param name="Deletes">The instance/s of OracleSqlBuilderDelete.</param>
		///// <returns>The instance of OracleSqlNonData.</returns>
		//internal OracleSqlNonData Execute(params OracleSqlBuilderDelete[] Deletes) {
		...
		internal OracleSqlNonData Execute(string ConnectionString, params OracleSqlBuilderNonQuery[] Queries) {
			...
			using (OracleConnection cn = new OracleConnection()) {
				...
				try {
					...
					try {
						double dblCounter = 0;
						foreach (OracleSqlBuilderNonQuery Query in Queries) {
							using (OracleCommand cmd = new OracleCommand()) {
								cmd.Connection = cn;
								...
								if (Query.GetParameters().Count > 0) {
									foreach (KeyValuePair<string, object> kvp in Query.GetParameters()) {
										cmd.Parameters.Add(new OracleParameter(kvp.Key, kvp.Value));
									}
